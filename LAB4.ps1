...
@{ n="L1CacheSize"; e={switch($_.L1CacheSize){$Null {$var="Object property is empty."; $var}}; 
 if($Null -ne $_.L1CacheSize){ $_.L1CacheSize }}},
@{ n="L2CacheSize"; e={switch($_.L2CacheSize){$Null {$var="Object property is empty."; $var}}; 
 if($Null -ne $_.L2CacheSize){ $_.L2CacheSize }}},
@{ n="L3CacheSize"; e={switch($_.L3CacheSize){$Null {$var="Object property is empty."; $var}}; 
...
@{ n="DNSDomain"; e={switch($_.DNSDomain){$Null {$var="Object property is empty.";$var }}; 
 if($Null -ne $_.DNSdomain){ $_.DNSdomain }}},
@{ n="DNSServersearchorder"; e={switch($_.DNSServersearchorder){$Null {$var="Object property is empty."; $var}};
